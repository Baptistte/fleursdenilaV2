...
// Insère les données de démo (5 produits + créneaux sur 2 jours).
// Utilisable en CLI (node db/seed.js) ou via la route admin /api/admin/seed-demo.
function seedDemo() {
...
if (require.main === module) {
  const r = seedDemo();
  console.log(`Seed OK — ${r.products} produits, ${r.slots} créneaux`);
}
